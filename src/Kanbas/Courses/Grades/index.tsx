...
export default function Grades() {
  return (
    <div id="wd-grades" className="table-responsive">
      <GradesControls />
      <div className="table-responsive">
        <table id="wd-grade-table" className="table table-striped table-bordered align-middle fs-5">
          <tbody className="text-center">
            ...
            <tr>
              ...
              <td>100%</td>
              <td>
                <input type="text" value="88.03" className="w-25 text-center" />%
              </td>
              <td>98.99%</td>
              <td>100%</td>
              <td>100%</td>
